...
int main()
{
  glfwInit();
   ...
   GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "LearnOpenGL", NULL, NULL);
    ...
    //Creating a program object to link shaders
    GLuint shaderProgram = glCreateProgram();//links shaders
    //attaching shaders
...
glDeleteShader(fragmentShader);
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0); //tells gpu how to interept data|attribute to configure -> Location=0 ->position
    glEnableVertexAttribArray(0); 

//Sent data to GPU but now need to tell GPU how to interept data
